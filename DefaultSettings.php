...
return array(
	...
	##
	# List of supported options and settings
	#
	# @since 3.0
	##
	'smwgElasticsearchConfig' => [
		...
		'replication' => [
			...
			'job.no.nodes.available.recovery.retries' => 5
		],
		'query' => [
			...
			// matches the SQLStore behaviour.
			'sort.property.exists' => true,

			// Sort by relevancy (aka score)
			//
			// Defines the name of the sortkey that can be used to sort returning
			// results by scores ES has determined (based on Term Frequency, Inverse
			// Document Frequency) for each query.
			//
			...
			// order of the query text
			'wide.proximity.match_phrase' => true,
			...
			// part of the title it relevance is boosted by 5 (i.e. count more
			...
			'wide.proximity.fields' => [ 'text_all', 'subject.title^5' ],
